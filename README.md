...
26 from Norway, below is a list of variuos codes.
...
|PokeOne | | | |
|- |DummyTrainer | Bored of grinding pokemon levels? 1 button_click and you got yourself a smart AI that grinds for you! |Patreon |
|- |ShinyHunter | Smart AI to hunt for shinies nearby. |Patreon |

## Visual Computing
|Title|Description|Access|
|:-|:-|:-|
|[GazeDetectionLeftRight](https://github.com/l0b5ter/UnFinished/blob/main/GazeDetectionLeftRight.py) | |Public |
